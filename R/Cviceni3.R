...
CoefVar(Policie$pulse)
CoefVar(Policie$diast)
...
hist(react, col = "magenta", border = "black", xlab = "Reakční doba", ylab = "absolutni četnosti", freq = F)
jadro <- density(react)
lines(jadro, col = "darkblue")
